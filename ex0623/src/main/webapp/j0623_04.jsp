	...
	<body>
		...
		<table>
			...
			<tr>
				...
				<td><%out.println(list.get(i).getKor()); %></td>
				<td><%out.println(list.get(i).getEng()); %></td>
				<td><%out.println(list.get(i).getMath()); %></td>
				<td><%out.println(list.get(i).getTotal()); %></td>
				<td><%out.println(list.get(i).getAvg()); %></td>
			</tr>
			<%} %>
