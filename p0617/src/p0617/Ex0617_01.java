...
public class Ex0617_01 {
	...
	public static void main(String[] args) {
		// work1 폴더에 txt 파일이 몇개 있는지 출력해보세요.
		...
		File[] f_name = fileName.listFiles();	//폴더안에 모든 파일들 정보 가져옴 
//		f_name[0].getName();
		
		// 배열만큼 for 돌려서 이름을 비교
		int count = 0;	//txt파일 갯수
		if(choice==1) {
			//포함되어 있는 형태
			...
			System.out.println("폴더안의 " + ext + "파일 갯수: " + count);
		}
...
//			}
//		}
//		System.out.println("폴더 갯수: " + count);
