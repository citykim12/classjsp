...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			function addInput(){
				...
				addHtml = addHtml + '<th><input type="checkbox" id="file'+count+'" name="filecheck" value="'+count+'"></th>';
	...
	<body>
		...
		<form action="testFormOk.jsp" method="post" id="testForm" name="testForm" enctype="multipart/form-data">
			...
			<button type="button" onclick="subInput()">파일업로드 행추가</button><br>
			<br><br>
		<table>
			<tr>
				<th>체크</th>
